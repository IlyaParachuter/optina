    ...
    public void process(char c)
    {
        switch (state)
        {
            ...
            case fsa_wait_234_c4:
                c4 = c;
                super.process((char)((c1-0xf0)*0x40000+(c2-0x80)*0x1000+(c3-0x80)*0x40+c4-0x80));
                state = fsa_start;
                break;
            ...
            case fsa_wait_23_c3:
                c3 = c;
                super.process((char)((c1-0xe0)*0x1000+(c2-0x80)*0x40+c3-0x80));
                state = fsa_start;
                break;

            case fsa_wait_2_c2:
                c2 = c;
                super.process((char)((c1-0xc0)*0x40+c2-0x80));
                state = fsa_start;
                break;
        }
    }
